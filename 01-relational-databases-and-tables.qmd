...
The `LEFT JOIN` retains customers even when they have no orders. Joins are developed fully in @sec-joins-and-relational-thinking; here, the query simply verifies that the two-table design behaves as intended.
